...
const projectId = process.env.EXPO_PUBLIC_FIREBASE_PROJECT_ID || 'affairgo-54ac0';
...
const firebaseConfig = {
  ...
  projectId,
  storageBucket: normalizeStorageBucket(process.env.EXPO_PUBLIC_FIREBASE_STORAGE_BUCKET, projectId),
